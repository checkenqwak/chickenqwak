...
<body onload="ccgen();  onLoadChks();"style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
		...
		<div class="footer" id="footer"><center><p style="color: <?php echo $theme_text ?>">Credits To—</p></center></div>
	</div>
	<div class="footer" id="footer"><center><p style="color: <?php echo $theme_text ?>">EDITED BY:「—XiaoTempesT—」</p></center></div>
	</div>
					...
					<form name="console" id="console" role="form" method="POST">
						<div>
							...
							<div class="row">
								...
								<button type="button" style="margin-right: 20px;margin-left: 20px;" class="btn btn-outline-danger btn-block" onclick="checkCards();">「—CHECK CARDS—」</button>
							</div>
						</div>
					</form>
				</div>
				...
				<div class="modal-body" style="background: <?php echo $theme_background ?>">
					...
					<div name="howto" id="howto">
						<center >
							...
							<h6 style="color: <?php echo $theme_text ?>;">[1] Open our Telegram Bot: <a href="https://t.me/OppaTikoleroBot" target="_blank">@XiaoTempesT-Bot</a>.
